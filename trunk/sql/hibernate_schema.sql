alter table ModuleFile drop foreign key FK42EDD6282C1163D4;
alter table ModuleFile drop foreign key FK42EDD62848DFE672;
...
create table ModuleFile (id bigint not null auto_increment, module bigint not null, content tinyblob, contentType varchar(255), fileName varchar(255), fileSize bigint, module_id bigint, primary key (id));
...
create table issues (id bigint not null auto_increment, ident varchar(255) not null unique, component bigint, module bigint, project bigint, assigned datetime, assignee bigint, created datetime, creator bigint, description varchar(255), modified datetime, modifier bigint, priority varchar(255), reported datetime, reporter bigint, status varchar(255), summary varchar(255), type varchar(255), primary key (id));
...
alter table ModuleFile add index FK42EDD6282C1163D4 (module_id), add constraint FK42EDD6282C1163D4 foreign key (module_id) references modules (id);
alter table ModuleFile add index FK42EDD62848DFE672 (module), add constraint FK42EDD62848DFE672 foreign key (module) references modules (id);
