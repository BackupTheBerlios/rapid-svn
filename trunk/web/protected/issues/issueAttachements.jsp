...
<stripes:layout-render name="/WEB-INF/layouts/tileLayout.jsp">
	...
	<c:set var="attachements" value="${issueAction.issueAttachements}"/>
		...
		<tr>
			<td>
				<stripes:link href="/protected/attachement.action" event="view" target="_blank" title="${file.description}">
					<stripes:link-param name="attachementType" value="issue"/>
			...
			<td>
				<stripes:link href="/protected/attachement.action" event="delete" onclick="ajaxUpdate(this.href,'_issueViewContent');return false;">
					<stripes:link-param name="attachementType" value="issue"/>
					<stripes:link-param name="attachementId" value="${file.id}"/>
					<stripes:link-param name="issueId" value="${param.issueId}"/>
					del
